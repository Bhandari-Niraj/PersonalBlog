...
<div class="w-4/5 m-auto pt-20">
	<form action="/blog" method="POST" enctype="multipart/form-data">
	    ...
	    <div class="bg-gray-lighter pt-15">
	    	<label class="w-44 flex flex-col items-center px-2 py-3 pg-white-rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer">
	    ...
	    <button type="submit" class="uppercase mt-15 bg-blue-500 text-gray-100 text-lg font-extrbold py-4 px-8 rounded-3xl">
	    	Submit Post
	    </button>
